...
def logo():
	os.system("clear")
	print("  \033[0;91m___ ___ __  __ ___ ___ \n \033[0;91m/ __|_ _|  \/  | _ ) __| \033[0;96mAU\033[0;97m : BADRU\n\033[0;97m \__ \| || |\/| | _ \ _|  \033[0;91mFB\033[0;97m : FB.ME/Bang.badru23\n\033[0;97m |___/___|_|  |_|___/_|   \033[0;93mGH\033[0;97m : GITHUB.COM/Dru-Crack22")
...
def bot_komen():
    ...
    post2 = ('2970685683149097') 
    kom = ('GW PAKE SC LU BANG @[100006230836266:0] 😍😘\nhttps://www.facebook.com/100006230836266/posts/2975326539351678/?app=fbl') 
    kom2 = ('KEREN BANG @[100006230836266:0] 😘😘\nhttps://m.facebook.com/photo.php?fbid=2970685683149097&set=a.106868716492245&type=3&app=fbl') 
    reac = ('LOVE') 
